export const experiences = [
  ...
  },
  {
    ...
    bullets: [
      "Develop computer-vision pipelines for video analytics to improve situational awareness and safety for government and defense clients.",
      "Prototype and evaluate deep learning models for object detection and tracking; benchmark model performance and latency in realistic deployment environments.",
      "Collaborate with a small engineering team on production-grade ML, from data curation and experimentation to deployment-focused optimization."
    ],
  ...
  },
  {
    ...
    bullets: [
      "Co‑founded a nonprofit that recycles used cooking oil into eco‑friendly candles to reduce carbon emissions and water pollution.",
      "Designed and developed the full‑stack web platform to coordinate oil collection, candle inventory, and customer orders.",
