...
export var createTouchable = function (Animated) {
    return createReactClass({
        ...
        render: function () {
            ...
            return (React.createElement(VrButton, { accessible: this.props.accessible, disabled: this.props.disabled, onLayout: this.props.onLayout, onButtonPress: this.touchableHandleActivePressIn, onButtonRelease: this.touchableHandleActivePressOut, onClick: this.touchableHandlePress, onLongClick: this.touchableHandleLongPress }, child));
        }
    });
};
